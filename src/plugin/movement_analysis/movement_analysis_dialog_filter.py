...
class Ui_AnimalMovementAnalysisDialogFilter(object):
    def setupUi(self, AnimalMovementAnalysisDialogFilter):
        ...
        self.pushButton = QtWidgets.QPushButton(AnimalMovementAnalysisDialogFilter)
        self.pushButton.setGeometry(QtCore.QRect(450, 190, 93, 28))
    ...
    def retranslateUi(self, AnimalMovementAnalysisDialogFilter):
        ...
        self.pushButton.setText(_translate("AnimalMovementAnalysisDialogFilter", "Calculate"))
