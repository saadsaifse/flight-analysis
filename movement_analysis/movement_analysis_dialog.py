...
FORM_CLASS_FILTER, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'movement_analysis_dialog_filter.ui'))


class AnimalMovementAnalysisDialogFilter(QtWidgets.QDialog, FORM_CLASS_FILTER):
    def __init__(self, parent=None):
        """Constructor."""
        super(AnimalMovementAnalysisDialogFilter, self).__init__(parent)
        # Set up the user interface from Designer through FORM_CLASS.
        # After self.setupUi() you can access any designer object by doing
        # self.<objectname>, and you can use autoconnect slots - see
        # http://qt-project.org/doc/qt-4.8/designer-using-a-ui-file.html
...
FORM_CLASS_RESULTS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'movement_analysis_dialog_results.ui'))


class AnimalMovementAnalysisDialogResults(QtWidgets.QDialog, FORM_CLASS_RESULTS):
    def __init__(self, parent=None):
        """Constructor."""
        super(AnimalMovementAnalysisDialogResults, self).__init__(parent)
        # Set up the user interface from Designer through FORM_CLASS.
        # After self.setupUi() you can access any designer object by doing
        # self.<objectname>, and you can use autoconnect slots - see
        # http://qt-project.org/doc/qt-4.8/designer-using-a-ui-file.html
